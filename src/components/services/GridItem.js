  ...
  return (
    <div
      className={
        intersecting
          ? serviceStyle.grid
          : `${serviceStyle.grid} ${serviceStyle.out_of_view}`
      }
      key={i}
    >
            ...
            {service.imgs !== null ? (
              <>
                <div
                  className={
                    intersecting
                      ? serviceStyle.grid__inner
                      : serviceStyle.out_of_view
                  }
                >
              ...
              <img
                ...
                className={
                  intersecting ? serviceStyle.in_view : serviceStyle.out_of_view
                }
              />
              ...
              <div className={serviceStyle.icons_grid}>
                ...
                <div className={serviceStyle.icons}>
